...
GO
/*
The column [dbo].[January_2021].[is_Expense] is being dropped, data loss could occur.
*/
...
GO
ALTER TABLE [dbo].[January_2021] DROP COLUMN [is_Expense];


GO
ALTER TABLE [dbo].[January_2021]
    ADD [Profit_or_Expense] VARCHAR (8) NULL;
